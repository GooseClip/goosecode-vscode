...
export namespace gooseclip.goosecode.ide.v1 {
    ...
    export class RequestMessage extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, RequestType.REQUEST_TYPE_UNSPECIFIED) as RequestType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != RequestType.REQUEST_TYPE_UNSPECIFIED)
    ...
    export class DocumentSymbol extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            if (!Array.isArray(data) && typeof data == "object") {
                ...
                if ("selection_range" in data && data.selection_range != undefined) {
                    this.selection_range = data.selection_range;
                }
        ...
        get kind() {
            return pb_1.Message.getFieldWithDefault(this, 3, SymbolKind.SYMBOL_KIND_UNSPECIFIED) as SymbolKind;
        }
        ...
        set selection_range(value: Range) {
            pb_1.Message.setWrapperField(this, 5, value);
        }
        get has_selection_range() {
            return pb_1.Message.getField(this, 5) != null;
        }
        get children() {
        ...
        static fromObject(data: {
            ...
            kind?: SymbolKind;
            range?: ReturnType<typeof Range.prototype.toObject>;
            selection_range?: ReturnType<typeof Range.prototype.toObject>;
            ...
            if (data.selection_range != null) {
                message.selection_range = Range.fromObject(data.selection_range);
            }
        ...
        toObject() {
            ...
            if (this.selection_range != null) {
                data.selection_range = this.selection_range.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.kind != SymbolKind.SYMBOL_KIND_UNSPECIFIED)
                writer.writeEnum(3, this.kind);
            if (this.has_range)
                writer.writeMessage(4, this.range, () => this.range.serialize(writer));
            if (this.has_selection_range)
                writer.writeMessage(5, this.selection_range, () => this.selection_range.serialize(writer));
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        reader.readMessage(message.selection_range, () => message.selection_range = Range.deserialize(reader));
                        break;
                    case 6:
    ...
    export class ResponseMessage extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, ResponseType.RESPONSE_TYPE_UNSPECIFIED) as ResponseType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != ResponseType.RESPONSE_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
            if (this.repository_snapshot_fingerprint.length)
                writer.writeString(2, this.repository_snapshot_fingerprint);
    ...
    export class FollowPush extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, FollowType.FOLLOW_TYPE_UNSPECIFIED) as FollowType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != FollowType.FOLLOW_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
    ...
    export class AppCommandPush extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, AppCommandType.APP_COMMAND_TYPE_UNSPECIFIED) as AppCommandType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != AppCommandType.APP_COMMAND_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class RegeneratePush extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, RegenerateType.REGENERATE_TYPE_UNSPECIFIED) as RegenerateType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != RegenerateType.REGENERATE_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
            if (!w)
                return writer.getResultBuffer();
        }
    ...
    export class ActiveSessionPush extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, ActiveSessionType.ACTIVE_SESSION_TYPE_UNSPECIFIED) as ActiveSessionType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != ActiveSessionType.ACTIVE_SESSION_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
    ...
    export class FileCommandPush extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, FileCommandType.FILE_COMMAND_TYPE_UNSPECIFIED) as FileCommandType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != FileCommandType.FILE_COMMAND_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
            if (this.workspace_root.length)
                writer.writeString(2, this.workspace_root);
    ...
    export class PushMessage extends pb_1.Message {
        ...
        get type() {
            return pb_1.Message.getFieldWithDefault(this, 1, PushType.PUSH_TYPE_UNSPECIFIED) as PushType;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            const writer = w || new pb_1.BinaryWriter();
            if (this.type != PushType.PUSH_TYPE_UNSPECIFIED)
                writer.writeEnum(1, this.type);
